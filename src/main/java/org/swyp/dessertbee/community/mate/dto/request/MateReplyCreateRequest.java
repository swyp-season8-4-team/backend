...
public class MateReplyCreateRequest {
    ...
    @Schema(description = "댓글 작성하는 사람 uuid", defaultValue = "false")
    private UUID userUuid;

    @NotBlank(message = "디저트메이트 댓글 내용을 작성해주세요.")
    @Schema(description = "디저트메이트 댓글 내용 작성", defaultValue = "false", example = "홍대 빵지순례 리스트 200개 있습니다. 같이 맛있는거 먹으러 가요.")
