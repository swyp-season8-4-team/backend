...
public class StoreDetailResponse {
    ...
    @Schema(description = "사용자 ID (비로그인 시 Null)", example = "3")
    private Long userId;
    ...
    @Schema(description = "가게 대표 이미지 URL 리스트")
    ...
    @Schema(description = "커뮤니티 리뷰 리스트")
    private List<ReviewSummaryResponse> communityReviews;

    @Schema(description = "디저트 메이트 모집글 리스트")
